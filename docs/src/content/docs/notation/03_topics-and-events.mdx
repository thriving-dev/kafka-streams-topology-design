...
<LibraryComponent name="record-envelope"
                  width={53}
                  title="Record/Message/Event (Envelope)."
...
<LibraryComponent name="tombstone"
                  width={44}
                  title="Tombstone."
                  description="<br><i>Deletions</i> (<i>null</i> values) are called <b>tombstones</b> within the Kafka (Streams) context."/>
