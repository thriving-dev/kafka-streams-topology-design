---
title: State Stores
description: This page covers how to represent state stores, and store types like In-Memory, RocksDB, and LRU Cache, along with global and versioned store variants and logging and caching attributes.
slug: notation/state-stores
sidebar:
  order: 6
head:
  - tag: title
    content: Notation > State Stores | The standard for designing and visualising Kafka Streams Topologies
---
