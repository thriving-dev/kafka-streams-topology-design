...
<LibraryComponent name="description-box-footer" width={368}
                  description="<p><b>Step Description - Footer Box</b> is a highlighted description that appears in a footer layout block, typically used to summarize or provide additional details for a step or process.</p>
