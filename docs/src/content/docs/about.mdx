---
title: About
description: Explore KSTD, the open standard for designing Kafka Stream topologies, offering guidelines, best practices, and the Excalidraw Library for visualisation.
template: splash
---
...
<TwoCols classAppend="!mt-8">
    <div>
      ...
      One of the key tools KSTD provides is the Excalidraw library, which offers complete coverage of the Kafka Streams DSL and essential infrastructure and architectural building blocks, making it easier to create clear, visual representations of their stream processing applications.
