---
title: About
description: Explore KSTD, the open standard for designing Kafka Stream topologies, offering guidelines, best practices, and the Excalidraw Library for visualization.
template: splash
---
