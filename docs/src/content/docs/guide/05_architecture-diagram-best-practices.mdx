...
- **Add a Key/Legend**: Always include a key or legend in your diagrams to explain the notation. This can help users understand the meaning behind the shapes, colors, and lines. Refer to the legend provided with the Excalidraw library [here](/notation/fundamentals/#legend-portraitlandscape).
