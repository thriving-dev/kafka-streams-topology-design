...
]} gallery="layout-and-building-blocks"/>
...
<AstroFancyCarousel autoplay={3500} classAppend="!mb-12" images={[
  {
    src: '/assets/guide/standard/kstd-standard-topology-layout-and-internals_1.svg',
    width: 3240,
    height: 1770,
    alt: "KSTD Standard - Topology Layout and Internals - Sub-topologies",
  },
  {
    src: '/assets/guide/standard/kstd-standard-topology-layout-and-internals_2.svg',
    width: 3240,
    height: 1770,
    alt: "KSTD Standard - Topology Layout and Internals - Grouped PAPI Elements",
  },
  {
    src: '/assets/guide/standard/kstd-standard-topology-layout-and-internals_3.svg',
    width: 3240,
    height: 1770,
    alt: "KSTD Standard - Topology Layout and Internals - Descriptions",
  },
  {
    src: '/assets/guide/standard/kstd-standard-topology-layout-and-internals_4.svg',
    width: 3240,
    height: 1770,
    alt: "KSTD Standard - Topology Layout and Internals - Raw Diagram",
  },
]} gallery="topology-layout-and-internals"/>

### Swimlanes

Swimlanes are a visual organization technique used in diagrams to clearly delineate processes, and workflows across
functional areas.

In KSTD swimlanes are not actively drawn, but maintaining consistent alignment for processing steps of individual streams
has proven to improve readability of designs.

<AstroFancyCarousel autoplay={false} classAppend="!mb-12" images={[
  {
    src: '/assets/guide/standard/kstd-standard-swimlanes_1.svg',
    width: 3240,
    height: 1770,
    alt: "KSTD Standard - Swimlanes",
  },
  {
    src: '/assets/guide/standard/kstd-standard-swimlanes_2.svg',
    width: 3240,
    height: 1770,
    alt: "KSTD Standard - Raw Diagram",
  },
]} gallery="swimlanes"/>
