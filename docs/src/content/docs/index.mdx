...
>
    <div class="sl-flex actions">
        ...
        <LinkButton href={globals.lib.install} icon="external" variant="minimal" set:html="TLDR; Install library" attrs={{class: "minimal", target: "_blank"}} />
    </div>
</Hero>
...
<Panel classAppend=""
    ...
    <AstroFancyCarousel images={[
      ...
      {
        src: '/assets/examples/kstd-example_ecommerce-product-view_v0.4.1.svg',
        width: 3120,
        height: 1421,
