...
description: Kafka Streams Topology Design (KSTD) is an open standard dedicated to the clear and effective description and visualisation of Kafka Stream topologies.
template: splash
head:
  - tag: title
...
import { Highlights, Highlight, Hero, Feature, Panel, TwoCols } from '../../components';
...
>
    <div class="sl-flex actions">
        <LinkButton href="/guide/getting-started/" icon="right-arrow" variant="primary" set:html="Getting Started" />
        <LinkButton href="/guide/kstd-standard/" icon="right-arrow" variant="secondary" set:html="Read the docs" />
        <LinkButton href={globals.lib.install} icon="external" variant="minimal" set:html="TLDR; Install library" target="_blank" attrs={{class: "minimal"}} />
    </div>
</Hero>
    ...
    <TwoCols classAppend="grid grid-cols-1 min-[800px]:grid-cols-[_1fr] min-[900px]:grid-cols-[_6fr,_4fr] min-[1100px]:grid-cols-[_7fr,_4fr] !gap-x-10 leading-6 min-[1100px]:leading-7">
        ...
        <div class="!mt-0 grid grid-cols-1 gap-4 pr-4 md:gap-6 min-[800px]:grid-cols-2 min-[900px]:grid-cols-1">
            ...
            <Feature title="Excalidraw Library"
                ...
                [Excalidraw](https://excalidraw.com), known for creating hand-drawn style diagrams and visualisations.
                ...
                [//]: # (> <span class="text-md"><Icon name="mdi:clippy" class="icon !inline-block !-mb-1.5 -ml-1 w-6 h-6" /> Excalidraw is a web-based, open-source tool for creating hand-drawn style diagrams and visualisations.</span>)
            </Feature>
        </div>
    </TwoCols>
</Panel>
...
<Panel titleTop="Introducing"
    ...
    <TwoCols classAppend="grid !grid-cols-1 min-[900px]:!grid-cols-[_2fr,_1fr] !gap-y-4 gap-x-8">
        ...
        <div>
            ...
            available describing a Kafka Streams topology on two hands.
            ...
            <div class="grid gap-1 grid-cols-2 min-[800px]:grid-cols-3 images-zoomable
                ...
                <div>
                    ![Diagram by Daniel Medeiros de Assis](../../assets/diagrams-out-in-the-www/topo-example-1.png)
                ...
                <div>
                    ![Diagram by zz85/kafka-streams-viz](../../assets/diagrams-out-in-the-www/zz85_kafka-streams-viz_1.webp)
                    <span>[[2] zz85/kafka-streams-viz](https://github.com/zz85/kafka-streams-viz)</span>
                </div>
                <div>
                    ![Diagram by Neha Narkhede (1)](../../assets/diagrams-out-in-the-www/Confluent_Narkhede_example-2.png)
                    <span>[[3] Neha Narkhede (1)](https://www.alibabacloud.com/blog/595602)</span>
                </div>
                <div>
                    ![Diagram by Neha Narkhede (2)](../../assets/diagrams-out-in-the-www/Confluent_Narkhede_example-1.png)
                    <span>[[4] Neha Narkhede (2)](https://www.alibabacloud.com/blog/595602)</span>
                </div>
                <div>
                    ![Diagram by Michelin Blog](../../assets/diagrams-out-in-the-www/micro_topo.jpeg)
                    <span>[[5] Michelin Blog](https://github.com/michelin/designing-kafka-streams-applications)</span>
                </div>
                <div>
                    ![Diagram by Redhead Blog, 2020](../../assets/diagrams-out-in-the-www/redhead-data-streaming-pipeline.jpg)
...
<Panel classAppend=""
    ...
    <AstroFancyCarousel images={[
      {
        src: '/assets/examples/kstd-example_wordcount-demo_0.3.0.svg',
        width: 2241,
        height: 871,
        alt: "'Kafka Streams Topology Design' diagram of an app processing 'User Flight Booking Status Update Notifications'",
      },
      {
        src: '/assets/examples/kstd-example_ecommerce-product-view_v0.5.0.svg',
        width: 3120,
        height: 1421,
      ...
      {
        src: '/assets/examples/kstd-example_user-booking-flight-status-notifications_v0.3.5.svg',
        width: 4744,
        height: 1930,
        alt: "'Kafka Streams Topology Design' diagram of an app processing 'User Flight Booking Status Update Notifications'",
      },
...
<Panel
    ...
    <div class="w-full text-center [&>a]:!inline-flex">
        <LinkButton href="/guide/getting-started/" variant="primary" set:html="Get started" />
        <LinkButton href="/guide/kstd-standard/" icon="right-arrow" variant="external" set:html="KSTD Standard" />
    </div>
</Panel>
...
<Panel classAppend="md:px-8"
    ...
    <TwoCols classAppend="leading-6 gap-y-6 md:gap-y-8 md:!gap-x-12
        ...
        <Highlight title="OK, Kafka Streams. What about other stream processing technilogies?"
                   icon="mdi:chevron-right">
          The library has been created while designing and implementing applications with Kafka Streams.
          So the milestone for version 1.0.0 naturally was to focus on Kafka Streams.

          Can the library be used to describe e.g. **Apache Flink** or **Apache Spark** applications?
          Simple answer: while no one's stopping you, but it's not supported *right now*.

          You want to adapt and create something similar to KSTD for other technologies? Please get in touch to
...
<Panel titleTop="Credits"
       title="Similar Projects"
       tagline="As the author, I want to acknowledge the resources and individuals who have provided valuable insights and inspiration along the way."
       classAppend="md:px-8 [&>div]:!-mb-0"
       centered>
  <TwoCols classAppend="leading-6 gap-y-6 md:gap-y-8 md:!gap-x-12
                          [&_li]:mb-4
                          [&>div]:!mt-0">
    <div>
      <div class="!mb-2 font-bold text-lg md:text-xl">References</div>
      - [**Flink Kafka Stream Implementation.**](https://github.com/ludovic-boutros/flink-kafka-stream-implementation)
      While not specifically focused on visualizing topologies, the diagrams in the repository were created independently of KSTD, driven by the shared vision of Adam Souquières and Ludovic Boutros. There seems to be a natural connection between our approaches.
      - <p>[**Designing Kafka Streams Applications.**](https://blogit.michelin.io/dkafka-streams/)
      The team at Michelin published an article on the concept of 'Master Topologies' and 'Micro Topologies' they established over the past years designing and building Kafka Streams applications.</p>
        <p>The methodology puts more focus on modelling business requirements, and goes less detailed into Kafka Streams. But the blog post emphasises the very same need for comprehensive and granular understanding of our end-to-end communication of solutions.</p>
      - **[zz85/kafka-streams-viz](https://github.com/zz85/kafka-streams-viz) by Joshua Koo.**
      A tool for visualizing stream topologies by generating diagrams from a kafka stream topology descriptions.
    </div>
    <div>
      <div class="!mb-2 font-bold text-lg md:text-xl">Special Thanks</div>
      - <p>**[C4 Model](https://c4model.com/) by Simon Brown.**
      Simon Brown has had a significant impact on the software engineering community by improving how teams approach and communicate software architecture.</p>
      <p>Through his creation of the *C4 Model*, he introduced a clear, accessible way to document systems, making architectural diagrams more practical and widely understood. His work has helped standardize architecture visualization, fostering better collaboration and understanding across development teams and organizations.</p>
      <p>Simon’s work has been a source of inspiration and a positive example, motivating me to create and share this standard with the community.</p>
      - **Excalidraw**
      has been my go-to tool for visualising Software Architecture for years. Its ease of use and support for creating reusable libraries allow me to sketch and create technical designs at a speed that does not hinder the creative process.
      I can brainstorm, bring my ideas and solutions "on paper", and live collaborate with a remote team. Big thank you, Excalidraw!
    </div>
  </TwoCols>
</Panel>
